...
class StaffHistoryBookingList extends StatelessWidget {
  const StaffHistoryBookingList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: bookingListViewModel.futureAllHistoryBookingList,
