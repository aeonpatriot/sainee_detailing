...
class CustomerHistoryBookingList extends StatelessWidget {
  const CustomerHistoryBookingList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: bookingListViewModel.futureCustomerHistoryBookingList,
