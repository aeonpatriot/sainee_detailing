...
class CustomerNewBookingList extends StatelessWidget {
  const CustomerNewBookingList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: bookingListViewModel.futureCustomerNewBookingList,
