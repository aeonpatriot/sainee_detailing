...
import 'package:sainee_detailing/widget/custom_shimmer_widget/customer_booking_list_shimmer.dart';

class CustomerConfirmedBookingList extends StatelessWidget {
  const CustomerConfirmedBookingList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: bookingListViewModel.futureCustomerConfirmedBookingList,
          ...
          case ConnectionState.waiting:
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return const CustomerBookingListShimmerWidget();
              },
            );
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                '${bookingListViewModel.formatDate(booking.date!)}   ${bookingListViewModel.formatTimeSlot(booking.timeSlot!)}',
                                style: TextStyle(color: Colors.grey.shade600),
                              ),
                              SizedBox(
                                width: double.infinity,
